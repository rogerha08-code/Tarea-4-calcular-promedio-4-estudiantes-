Sistema de Cálculo de Promedio de Estudiantes

Descripción:
Este programa permite ingresar cuatro calificaciones de un estudiante para calcular su promedio final. Según el resultado, el sistema indica si el estudiante aprobó o no.
...
Ejecutar la aplicación con F5 o el botón Iniciar

Se mostrará el formulario principal para ingresar las notas
